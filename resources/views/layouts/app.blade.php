        ...
        <nav class="navbar bg-body-tertiary bg-light bg-gradient shadow-sm  fixed-top">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <a class="text-reset me" style="margin-left:70%;"  href="{{route('delivered')}}"> 
...
@endforeach
                  ...
                  <a class="text-reset me-3" href="{{route('cart.index')}}">
                      <i class="fas fa-shopping-cart"></i> <span class="badge rounded-pill badge-notification bg-danger">{{$count}}</span>
                    </a>

                    @endif
                    <div class="position-absolute top-50 start-50 translate-middle">
                    {{-- <h5 class="text-danger" id="logo"></h5> --}}
                    ...
                    <h5 class="text-danger" id="logo">MR Nutrution</h5>
                </a>
            </div>
                  ...
                  <ul class="navbar-nav ms-auto" id="drop" >
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"  href="{{ route('customers.product') }}"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
                                        Products</a>
                        ...
                        <li class="nav-item ">
                            <a  class="nav-link " href="{{route('products.info')}}" >
